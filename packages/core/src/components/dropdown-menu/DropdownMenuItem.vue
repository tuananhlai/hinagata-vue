...
export interface DropdownMenuItemEmits extends RekaDropdownMenuItemEmits {}

export interface DropdownMenuItemSlots {
  default(): void;
}
</script>
...
<template>
  <RekaDropdownMenuItem :class="$style.root" v-bind="forwardedPropEmits">
    <slot />
